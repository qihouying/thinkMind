...
public class CombinationSumIV_377 {
     ...
     * combinations of numbers that are smaller than the target?
     ...
     Then think about the base case. Since if the target is 0, there is only one way to get zero, which is using 0, we
     can set comb[0] = 1.
    ...
    public int combinationSum4_dp_bu(int[] nums, int target) {
    ...
    public static void main(String[] args) {
        CombinationSumIV_377 combinationSum = new CombinationSumIV_377();
        int[] nums = {1, 2, 3};
        int target = 4;
        System.out.println(combinationSum.combinationSum4(nums, target));
        System.out.println(combinationSum.combinationSum4_dp(nums, target));
        System.out.println(combinationSum.combinationSum4_dp_bu(nums, target));
    }
}
