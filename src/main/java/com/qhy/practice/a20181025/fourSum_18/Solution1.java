package com.qhy.practice.a20181025.fourSum_18;
...
public class Solution1 {
    public List<List<Integer>> fourSum(int[] nums, int target) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            List<List<Integer>> threeSumResult = threeSum(nums, i+1, targetThree);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution1.fourSum(nums, 0));
    }
}
